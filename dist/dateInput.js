...
var DateInput = function DateInput(props) {
  ...
  var formatarDataUs = function formatarDataUs(dataInput) {
    ...
    try {
      if (dataInput.indexOf('_') > 0 || isNaN(Number(mes)) || mes == '__' || Number(mes) < 1 || Number(mes) > 12 || isNaN(Number(ano))) {
        throw "Data Inválida";
      }
      return (0, _datas.formatarDataToUtc)(ano + '-' + mes + '-' + dia + ' 00:00:00');
    } catch (e) {
      throw "Data Inválida";
    }
  };
  var formatarDataBr = function formatarDataBr(dataInput) {
    if (_typeof(dataInput) == 'object') {
      ...
      try {
        ...
        var a = (0, _datas.formatarData)("".concat(ano, "-").concat(mes, "-").concat(dia, "T").concat(hora, "Z"));
        return a;
      } catch (e) {
        return undefined;
      }
